Contributing to ESTERRA Coin Core
==================================

The ESTERRA Coin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ESTERRA Coin Core project, and is not to be
confused with overall ESTERRA Coin Network Protocol consensus changes.

Whether a pull request is merged into ESTERRA Coin Core rests with the project merge
...
Patches that change ESTERRA Coin consensus rules are considerably more involved than
...
Where a patch set proposes to change the ESTERRA Coin consensus, it must have been
...
The project leader is the release manager for each ESTERRA Coin Core release.
