...
#if defined(NDEBUG)
#error "ESTERRA Coin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uestc) are considered zero fee (for relaying and mining)
