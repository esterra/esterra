...
/* ESTERRA Coin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "ESTERRA"
#define QAPP_ORG_DOMAIN "savebitcoin.io"
#define QAPP_APP_NAME_DEFAULT "ESTERRA-Qt"
#define QAPP_APP_NAME_TESTNET "ESTERRA-Qt-testnet"
