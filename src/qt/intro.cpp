...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ESTERRA Coin Core"),
     ...
     * override -datadir in the esterra.conf file in the default data directory
     * (to be consistent with esterrad behavior)
     */
    if (dataDir != getDefaultDataDirectory())
