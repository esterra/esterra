...
/** Utility functions used by the ESTERRA Qt UI.
 */
namespace GUIUtil
{
...
// Render ESTC addresses in monospace font
...
// Parse "esterra:" URI into recipient object, return true on successful parsing
