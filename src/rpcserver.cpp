...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop ESTERRA Coin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "ESTERRA Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ESTERRA Coin features */
        {"esterra", "masternode", &masternode, true, true, false},
        {"esterra", "listmasternodes", &listmasternodes, true, true, false},
        {"esterra", "getmasternodecount", &getmasternodecount, true, true, false},
        {"esterra", "masternodeconnect", &masternodeconnect, true, true, false},
        {"esterra", "masternodecurrent", &masternodecurrent, true, true, false},
        {"esterra", "masternodedebug", &masternodedebug, true, true, false},
        {"esterra", "startmasternode", &startmasternode, true, true, false},
        {"esterra", "createmasternodekey", &createmasternodekey, true, true, false},
        {"esterra", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"esterra", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"esterra", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"esterra", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"esterra", "getmasternodescores", &getmasternodescores, true, true, false},
        {"esterra", "mnbudget", &mnbudget, true, true, false},
        {"esterra", "preparebudget", &preparebudget, true, true, false},
        {"esterra", "submitbudget", &submitbudget, true, true, false},
        {"esterra", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"esterra", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"esterra", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"esterra", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"esterra", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"esterra", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"esterra", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"esterra", "checkbudgets", &checkbudgets, true, true, false},
        {"esterra", "mnsync", &mnsync, true, true, false},
        {"esterra", "spork", &spork, true, true, false},
        {"esterra", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"esterra", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"esterra", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"esterra", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"esterra", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"esterra", "mncommunityvote", &mncommunityvote, true, true, false},
...
{
    return "> esterra-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9457/\n";
}
