...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ESTERRA Coin Core esterra-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  esterra-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ESTERRA Coin transaction") + "\n" +
                               "  esterra-tx [options] -create [commands]   " + _("Create hex-encoded ESTERRA Coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ESTERRA Coin transaction
