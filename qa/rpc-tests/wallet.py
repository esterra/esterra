...
#   c) node1 mines 32 blocks, so now node 0 has 500000ESTC, node 1 has 4250ESTC, node2 has none.
#   d) node0 sends 601 ESTC to node2, in two transactions (301 ESTC, then 300 ESTC).
