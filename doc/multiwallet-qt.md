...
In order to support loading of multiple wallets in esterra-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is esterra.cpp.
...
Changes to esterra.cpp
----------------------
esterra.cpp is the entry point into esterra-qt, and as such, will require some minor modifications to provide hooks for
