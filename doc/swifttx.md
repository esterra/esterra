...
This mechanism has been integrated into Bitcore-Node-ESTERRA which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/esterra/insight-api-esterra#web-socket-api](https://github.com/esterra/insight-api-esterra#web-socket-api)
* API: [https://github.com/esterra/insight-api-esterra#swifttx-transactions](https://github.com/esterra/insight-api-esterra#swifttx-transactions)
...
By default, the ESTERRA Coin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the ESTERRA Coin Core daemon:
