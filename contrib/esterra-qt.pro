...
RESOURCES += src/qt/esterra.qrc src/qt/esterra_locale.qrc

TRANSLATIONS += src/qt/locale/esterra_bg.ts \
                src/qt/locale/esterra_de.ts \
                src/qt/locale/esterra_en.ts \
                src/qt/locale/esterra_es.ts \
                src/qt/locale/esterra_fi.ts \
                src/qt/locale/esterra_fr.ts \
                src/qt/locale/esterra_it.ts \
                src/qt/locale/esterra_ja.ts \
                src/qt/locale/esterra_pl.ts \
                src/qt/locale/esterra_pt.ts \
                src/qt/locale/esterra_ru.ts \
                src/qt/locale/esterra_sk.ts \
                src/qt/locale/esterra_sv.ts \
                src/qt/locale/esterra_vi.ts \
                src/qt/locale/esterra_zh_CN.ts \
                src/qt/locale/esterra_zh_TW.ts
